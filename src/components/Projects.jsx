          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="pt-2 font-mono text-gray-600 text-sm">-React, JS, Vite, Appwrite, RTK...</p>
                <a
                  href="https://github.com/AshwinSunuwarr2/production-grade-project.git"
                  target="_blank"
            ...
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="pt-2 font-mono text-gray-600 text-sm">-Python, MySQL, OpenCV, Tkinter library...</p>
                <a
                  href="https://github.com/AshwinSunuwarr2/major-project.git"
                  target="_blank"
                  className="block text-blue-600 hover:underline mt-4"
                >
                  Check on GitHub! 🚀
            ...
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="pt-2 font-mono text-gray-600 text-sm">-Flutter, Dart, Firebase...</p>
                <a
                  href="https://github.com/AshwinSunuwarr2/FreeLwithKhalti.git"
                  target="_blank"
                  className="block text-blue-600 hover:underline mt-4"
                >
                  Check on GitHub! 🚀
            ...
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <a
                  href="https://nepaliflimcampus.acsskillsassessment.com/"
                  target="_blank"
                  className="block text-blue-600 hover:underline mt-4"
                >
                  Nepal Film Campus 🚀
                ...
                <a
                  href="https://superassignmenthelp.com/"
                  target="_blank"
                  className="block text-blue-600 hover:underline mt-4"
                >
            ...
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="pt-2 font-mono text-gray-600 text-sm">-Java, MySQL...</p>
                <a
                  href="#"
            ...
            <div className="group bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="pt-2 font-mono text-gray-600 text-sm">-HTML, CSS, React, Native,JS, Python, C#, Unity...</p>
                <a
                  href="https://github.com/AshwinSunuwarr2?tab=repositories"
                  target="_blank"
                  className="block text-blue-600 hover:underline mt-4"
                >
                  Check on GitHub! 🚀

  ...
  return (
    <div className="bg-primary flex items-center h-screen">
        ...
        <div className="mx-auto text-center text-white">
          ...
          <div className="flex flex-row justify-center animate-typing">
          ...
          <p className="text-xl mt-4 mb-12 font-montserrat">
          I code, I design, I drink coffee (a lot), and sometimes, I even sleep! 
          </p>
          <Link
            to="/contact"
            className=" bg-[#e21612c0] text-white py-4 px-6 md:px-8 rounded-full hover:bg-[#e21612] mr-2 font-montserrat text-sm"
          >
            HIRE ME
          </Link>
          <a
            href="ashwinCV.pdf"
            target="_blank"
            className=" bg-[#e21612c0] text-white py-4 px-6 md:px-8  rounded-full hover:bg-[#e21612] ml-2 font-montserrat text-sm"
            download
          >
            DOWNLOAD CV
          </a>

    ...
    <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            ...
            <div className="relative lg:ml-32 lg:block lg:w-1/2 order-1 mt-4">
                ...
                <div className="animate-ltr duration-500 ease-in-out abg-orange-400 mx-auto w-fit overflow-hidden rounded-[10rem] rounded-br-none rounded-tl-none m-2 shadow-xl">
                     <img src={me} alt="" className="size-[350px] md:w-[400px] md:h-[500px] object-cover filter contrast-[1.2] brightness-95 saturate-[1.5]"/>
